...
import { WHITELISTED, CONTRACT_ADDRESS, CONTRACT_ABI } from "@/utils/constants";
...
// On aurait une liste de personnes whitelistées
// Ensuite on a une adresse admin qui vient créer off chain les signatures pour chaque personne whitelistée
// On met ces signatures en bdd
// On vérifie on-chain que c'est bien l'adresse admin qui a généré cette signature
// Si c'est le cas, la personne est whitelistée
